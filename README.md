...
- **[new-vault-project](./skills/engineering/new-vault-project/SKILL.md)** — Scaffold a vault project directory. Invoked automatically by `to-prd` and `to-issues`; reach for it directly to create a project dir without publishing.
