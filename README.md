...
- **[setup-project-vault](./skills/engineering/setup-project-vault/SKILL.md)** — Vault-first alternative to `setup-matt-pocock-skills`: clone an Obsidian project vault into the repo and wire ADRs/PRDs/issues (kanban board) into it.
...
- **[new-vault-project](./skills/engineering/new-vault-project/SKILL.md)** — Scaffold a vault project directory (`vault/Projects/<slug>/`). Invoked automatically by `to-prd` and `to-issues`; reach for it directly to create a project dir without publishing.
